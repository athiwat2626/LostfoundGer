  ...
  return (
    <div>
      ...
      <div className="mb-6">
          ...
          คลิกบนแผนที่เพื่อเลือกสถานที่ที่ทำของหายใน ม.เกษตร กำแพงแสน
        </p>
        <MapContainer
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="mb-4">
            <label className="block mb-2 font-medium">วันที่หาย</label>
            <input
              type="date"
              name="lost_date"
          ...
          <div className="mb-4 relative">
            <label className="block mb-2 font-medium">สถานที่หาย</label>
            <input
              type="text"
              name="lost_location"
